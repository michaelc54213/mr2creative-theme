...
<div class="frame frame--active">
          ...
          <div class="leader">
             ...
             <h1 style="float: left; display: inline-block;" class="blog-title-style"><a href="http://localhost/mr2creative.com/blog/wordpress/" style="text-decoration: none; color: #ba9d78; margin-left: 10px; font-family: Roboto, sans-serif; font-weight: 100; font-size: 36px;">The Official Mr2Creative Blog</a></h1>
            
          <!-- MAIN BLOG LOOP FOR POSTS -->
              <?php if (is_category($cat)) : while ( have_posts() ) : the_post(); ?>
